...
<body>
  ...
  <nav class="navbar">
      ...
      <a href="#" class="text-2xl font-montserrat font-bold text-dark">Layanan Kritik dan Saran</a>
       <!-- Desktop Menu -->
        <div class="hidden md:flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0 mt-4 md:mt-0">
            <a href="{{ route('dekan.dashboard') }}" class="text-dark hover:text-gray-200 transition active">Beranda</a>
    ...
    <div id="menu" class="hidden flex flex-col space-y-4 bg-white text-primary py-4 px-6 shadow-lg md:hidden">
      <a href="{{ route('dekan.dashboard') }}" class="hover:bg-gray-100 p-2 rounded transition active">Beranda</a>
  ...
  <main class="container mx-auto py-16">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div class="bg-white shadow-lg rounded-lg p-8">
        <h2 class="text-2xl font-montserrat font-bold mb-4 text-primary">Lihat Manajemen Layanan</h2>
        <p class="text-gray-600 mb-6">Manajemen masukan yang telah diterima untuk ditindaklanjuti.</p>
        <a href="{{ route('dekan.manajemen') }}" class="btn-primary px-6 py-3 rounded-lg inline-block text-center">Lihat Masukan</a>
      </div>
    </div>
  </main>
