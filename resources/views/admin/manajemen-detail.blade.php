            ...
            <div class="border-b pb-4">
              ...
              <div class="border-b pb-4">
                ...
                @else
                    ...
                    <form action="{{ route('admin.tanggapan.update', $kritiksaran->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <textarea 
                            name="tanggapan" 
                        ...
                        @if($kritiksaran->status === 'Proses')
                            <button 
                                type="submit" 
                                class="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:ring-2 focus:ring-blue-400">
                                Update Tanggapan
                            </button>
                        @endif
                    </form>
